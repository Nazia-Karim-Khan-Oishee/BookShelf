...
-- --
-- -- Host: 127.0.0.1
-- -- Generation Time: May 30, 2023 at 04:00 PM
...
-- --
-- ALTER TABLE `all_copies_of_books`
--   MODIFY `copy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2023 at 06:39 PM
-- Server version: 10.4.25-MariaDB
-- PHP Version: 7.4.30
...
('9780253201867', 'Pather Panchali: Song of the Road', 'Bibhutibhushan Bandyopadhyay', '1', 'Indiana University Press', 'patherpachali.jpg'),
('9780702208331', 'Padma River Boatman', 'Manik Bandopadhyay', '1', 'University of Queensland Press', 'Padma River Boatman.jpg');
...
--
ALTER TABLE `all_copies_of_books`
  MODIFY `copy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
